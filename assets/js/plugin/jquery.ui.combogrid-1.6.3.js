...
(function($, undefined) {
    ...
    $.widget("cg.combogrid", {
        options: {
            ...
            showOn: false,
            width: null,
            authorizationHeader: null // custom header
        },
        source: null,
        lastOrdered: "",
        cssCol: "",
        ...
        _create: function() {
            ...
            this.element
                ...
                .bind("focus.combogrid", function() {
                    if (self.options.disabled || self.selectedItem) {
                        return;
                    }
                    ...
                    // Previously, it was like this, then modified by Indra
                    // self.selectedItem = null;
            ...
            this.options.source = function(request, response) {
                $.ajax({
                    ...
                    beforeSend: function(xhrObj) {
                        if (self.options.authorizationHeader) {
                            xhrObj.setRequestHeader('Authorization', self.options.authorizationHeader);
                        }
                    },
                    data: {
