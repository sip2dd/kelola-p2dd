(function() {
    ...
    function moduleConfig($translatePartialLoaderProvider, $stateProvider, triMenuProvider) {
        ...
        .state('triangular.admin-default.elements-icons', {
            ...
            controllerAs: 'vm',
            resolve: {
                icons: function($http, EnvironmentConfig) {
                    return $http({
                        method: 'GET',
                        url: EnvironmentConfig.api + 'elements/icons'
                    });
                },
                fa: function($http, EnvironmentConfig) {
                    return $http({
                        method: 'GET',
                        url: EnvironmentConfig.api + 'elements/icons-fa'
                    });
                }
            }
        })
        ...
        .state('triangular.admin-default.elements-lists', {
            ...
            controllerAs: 'vm',
            resolve: {
                emails: function($http, EnvironmentConfig) {
                    return $http({
                        method: 'GET',
        ...
        .state('triangular.admin-default.elements-chips', {
            ...
            controllerAs: 'vm',
            resolve: {
                contacts: function($http, EnvironmentConfig) {
                    return $http({
                        method: 'GET',
                        url: EnvironmentConfig.api + 'email/contacts'
                    });
                }
            }
        })
