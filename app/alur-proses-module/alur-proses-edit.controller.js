(function () {
    ...
    angular
        ...
        .controller('AlurProsesEditController', AlurProsesEditController);

    /* @ngInject */
    function AlurProsesEditController(
        $http, $state, $stateParams, $log, $mdDialog, EnvironmentConfig, AppFactory, AlurProsesFactory, _
    ) {
        var vm = this;
        ...
        vm.removeDaftarProses = function (index) {
            if (angular.isDefined(vm.alur_proses.daftar_proses[index].id)) {
                ...
                $mdDialog.show(
                    ...
                    AlurProsesFactory.deleteDaftarProses(daftarProsesId)
                        .then(function () {
