(function () {
    ...
    angular
        ...
        .controller('PermohonanIzinAddController', PermohonanIzinAddController);

    /* @ngInject */
    function PermohonanIzinAddController(
        $http, $state, $log, $mdDialog, $scope, $mdMedia, $document, EnvironmentConfig, APP_CONFIG,
