(function() {
    ...
    angular
        ...
        .controller('FormAssessmentAdd', FormAssessmentAdd);

    /* @ngInject */
    function FormAssessmentAdd($http, APP_CONFIG, $state, $mdDialog, $scope, $mdMedia, EnvironmentConfig, $log, $timeout, AppFactory, FormAssessmentFactory) {
        var vm = this;
