(function() {
    ...
    /* @ngInject */
    function triMenuItemController($scope, $mdSidenav, $state, $filter, triBreadcrumbsService, $location) {
        ...
        function openLink() {
            ...
            if (angular.isDefined(triMenuItem.item.uri)) {
                $location.path(triMenuItem.item.uri);
            } else {
