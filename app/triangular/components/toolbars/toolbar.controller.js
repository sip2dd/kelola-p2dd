(function() {
    ...
    function DefaultToolbarController(
        $scope, $rootScope, $mdMedia, $translate, $filter, $mdUtil, $mdSidenav, $mdToast, $document,
        triBreadcrumbsService, triSettings, triLayout, AdminProfileFactory
    ) {
        var vm = this;
        ...
        // Add info of current Pengguna
        if (!$rootScope.currentUser) {
            AdminProfileFactory.getProfile().then(function () {
