(function() {
    ...
    angular
        ...
        .controller('PemohonEditController', PemohonEditController);

    /* @ngInject */
    function PemohonEditController(
        $state, $stateParams, $http, $log,
        APP_CONFIG, EnvironmentConfig, AppFactory, PemohonFactory, PermohonanIzinFactory, usernameFilter
    ) {
        var vm = this;
