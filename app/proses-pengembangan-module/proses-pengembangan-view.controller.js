(function() {
    ...
    angular
        ...
        .controller('ProsesPengembanganView', ProsesPengembanganView);

    /* @ngInject */
    function ProsesPengembanganView($http, $state, EnvironmentConfig, $stateParams, $log, $timeout, AppFactory, Upload,ProsesPengembanganFactory) {
        var vm = this;
        var komentar;
        var id_dokumen;
