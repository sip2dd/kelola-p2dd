(function () {
    ...
    angular
        ...
        .controller('TemplateDataEditController', TemplateDataEditController);

    /* @ngInject */
    function TemplateDataEditController(
        $http, $state, $stateParams, $mdDialog, $mdMedia, $log, $scope, 
        $timeout, $mdToast, $window, $document, EnvironmentConfig, 
        AppFactory, TemplateDataFactory, Upload,
        DYNAMIC, _
    ) {
        var vm = this;
