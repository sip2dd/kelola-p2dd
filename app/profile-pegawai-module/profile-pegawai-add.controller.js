(function () {
    ...
    angular
        ...
        .controller('ProfilePegawaiAddController', ProfilePegawaiAddController);

    /* @ngInject */
    function ProfilePegawaiAddController(
        $http, $state, EnvironmentConfig, $stateParams, $mdDialog, $mdMedia, $scope, $log,
        AppFactory, ProfilePegawaiFactory, Upload, UnitFactory, JabatanFactory, PosisiFactory) {
        var vm = this;
        ...
        vm.removePegawaiAtribut = function (index) {
            if (angular.isDefined(vm.pegawai_atribut[index].id)) {
                ...
                $mdDialog.show(
                    ...
                    ProfilePegawaiFactory.deletePegawaiAtribut(pegawaiAtributId).then(function () {
        ...
        vm.removePegawaiKeluarga = function (index) {
            if (angular.isDefined(vm.pegawai_keluarga[index].id)) {
                ...
                $mdDialog.show(
                    ...
                    ProfilePegawaiFactory.deletePegawaiAtribut(pegawaiKeluargaId).then(function () {
